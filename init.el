...
(let* ((no-ssl (and (memq system-type '(windows-nt ms-dos))
  ...
  (add-to-list 'package-archives (cons "org" (concat proto "https://orgmode.org/elpa/")) t)
...
(custom-set-variables
 ...
 '(package-selected-packages (quote (rainbow-delimiters nord-theme ledger-mode ledger))))
(custom-set-faces
